 ...
 */
#ifndef __MX6ULLMY_CONFIG_H
#define __MX6ULLMY_CONFIG_H
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				...
				"if test $board_name = MY && test $board_rev = 14X14; then " \
					"setenv fdt_file imx6ull-14x14-my.dtb; fi; " \
				"if test $fdt_file = undefined; then " \
		...
		"findtee="\
			"if test $tee_file = undefined; then " \
				...
				"if test $board_name = EVK && test $board_rev = 14X14; then " \
					"setenv tee_file uTee-6ullevk; fi; " \
				"if test $board_name = MY && test $board_rev = 14X14; then " \
					"setenv tee_file uTee-6ullmy; fi; " \
				"if test $tee_file = undefined; then " \
...
#define CONFIG_IPADDR       192.168.50.44      /* board ip */
#define CONFIG_SERVERIP     192.168.50.11      /* ubuntu ip */
#define CONFIG_GATEWAYIP    192.168.50.1        /* board gateway ip */
